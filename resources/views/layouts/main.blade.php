...
<body>
    ...
    <header>
        <div>
            @if (!Auth::check())
                <a href="{{route('root.home')}}" class="logo"><img src="{{ asset('storage/images/logo/touchfic-logo.svg') }}" alt="touchfic">Touchfic</a>
            @else
                <a href="{{route('dashboard')}}" class="logo"><img src="{{ asset('storage/images/logo/touchfic-logo.svg') }}" alt="touchfic">Touchfic</a>
            @endif
        </div>
        @if (Auth::check())
